...
var toStructuredGridPositionsFromV1 = function toStructuredGridPositionsFromV1(gridPositions) {
  return (0, _migrator_utils.sortTiles)((0, _compact2.default)((0, _map2.default)(gridPositions, function (gpos) {
    if (!gpos) {
      return null;
    }
    var uuid = gpos.uuid;
    ...
    return _extends({}, gpos, { uuid: parseInt(uuid.slice(UUID_PREFIX.length)), type: 'tile' });
  })));
};
